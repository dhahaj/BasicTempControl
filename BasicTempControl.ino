/*
   ...
   This program reads a dallas temperature probe as input, potentiometer as setpoint,
   drives an analog output.It lights an LED when the temperature has reached the setpoint.
*/
...
bool updateTemperature()
{
  if ((millis() - lastTempUpdate) > TEMP_READ_DELAY) {
    ...
    Serial.print(setPoint); Serial.print(" | "); Serial.println(analogRead(A1));
